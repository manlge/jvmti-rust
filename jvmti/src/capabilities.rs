...
impl Capabilities {
    ...
    pub fn from_native(native_caps: &jvmtiCapabilities) -> Capabilities {
        Capabilities {
            ...
            can_generate_field_modification_events: native_caps._bindgen_bitfield_1_ & 0x00000002
                > 0,
            ...
            can_generate_compiled_method_load_events: native_caps._bindgen_bitfield_1_ & 0x08000000
                > 0,
            ...
            can_generate_native_method_bind_events: native_caps._bindgen_bitfield_1_ & 0x40000000
                > 0,
            can_generate_garbage_collection_events: native_caps._bindgen_bitfield_1_ & 0x80000000
                > 0,
            ...
            can_get_owned_monitor_stack_depth_info: native_caps._bindgen_bitfield_2_ & 0x00000004
                > 0,
            ...
            can_generate_resource_exhaustion_heap_events: native_caps._bindgen_bitfield_2_
                & 0x00000080
                > 0,
            can_generate_resource_exhaustion_threads_events: native_caps._bindgen_bitfield_2_
                & 0x00000100
                > 0,
        }
    }
    ...
    pub fn to_native(&self) -> jvmtiCapabilities {
        ...
        let result: Vec<u32> = fields
            .iter()
            .map(|f| {
                f.iter()
                    .map(|(&value, &switch)| if switch { value } else { 0 })
