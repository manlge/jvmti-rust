use super::bytecode::*;
use super::environment::jni::{JNIEnvironment, JNI};
use super::environment::jvmti::{JVMTIEnvironment, JVMTI};
...
unsafe extern "C" fn local_cb_vm_object_alloc(
    jvmti_env: *mut jvmtiEnv,
    jni_env: *mut JNIEnv,
    thread: JavaThread,
    object: JavaObject,
    object_klass: JavaClass,
    size: jlong,
) -> () {
...
#[allow(unused_variables)]
unsafe extern "C" fn local_cb_method_entry(
    jvmti_env: *mut jvmtiEnv,
    jni_env: *mut JNIEnv,
    thread: JavaThread,
    method: JavaMethod,
...
#[allow(unused_variables)]
unsafe extern "C" fn local_cb_method_exit(
    jvmti_env: *mut jvmtiEnv,
    jni_env: *mut JNIEnv,
    thread: jthread,
    method: jmethodID,
...
#[allow(unused_variables)]
unsafe extern "C" fn local_cb_exception(
    jvmti_env: *mut jvmtiEnv,
    jni_env: *mut JNIEnv,
    thread: jthread,
    method: jmethodID,
...
#[allow(unused_variables)]
unsafe extern "C" fn local_cb_exception_catch(
    jvmti_env: *mut jvmtiEnv,
    jni_env: *mut JNIEnv,
    thread: jthread,
    method: jmethodID,
...
#[allow(unused_variables)]
unsafe extern "C" fn local_cb_monitor_wait(
    jvmti_env: *mut jvmtiEnv,
    jni_env: *mut JNIEnv,
    thread: jthread,
    object: jobject,
...
#[allow(unused_variables)]
unsafe extern "C" fn local_cb_monitor_waited(
    jvmti_env: *mut jvmtiEnv,
    jni_env: *mut JNIEnv,
    thread: jthread,
    object: jobject,
...
#[allow(unused_variables)]
unsafe extern "C" fn local_cb_monitor_contended_enter(
    jvmti_env: *mut jvmtiEnv,
    jni_env: *mut JNIEnv,
    thread: jthread,
    object: jobject,
...
#[allow(unused_variables)]
unsafe extern "C" fn local_cb_monitor_contended_entered(
    jvmti_env: *mut jvmtiEnv,
    jni_env: *mut JNIEnv,
    thread: jthread,
    object: jobject,
...
#[allow(unused_variables)]
unsafe extern "C" fn local_cb_thread_start(
    jvmti_env: *mut jvmtiEnv,
    jni_env: *mut JNIEnv,
    thread: jthread,
) -> () {
...
#[allow(unused_variables)]
unsafe extern "C" fn local_cb_thread_end(
    jvmti_env: *mut jvmtiEnv,
    jni_env: *mut JNIEnv,
    thread: jthread,
) -> () {
...
unsafe extern "C" fn local_cb_garbage_collection_start(jvmti_env: *mut jvmtiEnv) -> () {
    match CALLBACK_TABLE.garbage_collection_start {
        ...
        None => {
            println!("No dynamic callback method was found for garbage collection start events")
        }
    }
}
...
#[allow(unused_variables)]
unsafe extern "C" fn local_cb_breakpoint(
    jvmti_env: *mut jvmtiEnv,
    jni_env: *mut JNIEnv,
    thread: jthread,
    method: jmethodID,
...
unsafe extern "C" fn local_cb_class_file_load_hook(
    ...
    jni_env: JNIEnvPtr,
    class_being_redefined: JavaClass,
    loader: JavaObject,
    name: *const c_char,
    ...
    match CALLBACK_TABLE.class_file_load_hook {
        Some(function) => {
            ...
            match function(ClassFileLoadEvent {
...
#[allow(unused_variables)]
unsafe extern "C" fn local_cb_class_load(
    jvmti_env: *mut jvmtiEnv,
    jni_env: *mut JNIEnv,
    thread: jthread,
    klass: jclass,
...
#[allow(unused_variables)]
unsafe extern "C" fn local_cb_class_prepare(
    jvmti_env: *mut jvmtiEnv,
    jni_env: *mut JNIEnv,
    thread: jthread,
    klass: jclass,
...
#[allow(unused_variables)]
unsafe extern "C" fn local_cb_compiled_method_load(
    jvmti_env: *mut jvmtiEnv,
    method: jmethodID,
    code_size: jint,
...
#[allow(unused_variables)]
unsafe extern "C" fn local_cb_compiled_method_unload(
    jvmti_env: *mut jvmtiEnv,
    method: jmethodID,
    code_addr: *const c_void,
) -> () {
...
#[allow(unused_variables)]
unsafe extern "C" fn local_cb_dynamic_code_generated(
    jvmti_env: *mut jvmtiEnv,
    name: *const c_char,
...
#[allow(unused_variables)]
unsafe extern "C" fn local_cb_field_access(
    jvmti_env: *mut jvmtiEnv,
    jni_env: *mut JNIEnv,
    thread: jthread,
    method: jmethodID,
...
#[allow(unused_variables)]
unsafe extern "C" fn local_cb_field_modification(
    jvmti_env: *mut jvmtiEnv,
    jni_env: *mut JNIEnv,
    thread: jthread,
    method: jmethodID,
...
#[allow(unused_variables)]
unsafe extern "C" fn local_cb_frame_pop(
    jvmti_env: *mut jvmtiEnv,
    jni_env: *mut JNIEnv,
    thread: jthread,
    method: jmethodID,
...
#[allow(unused_variables)]
unsafe extern "C" fn local_cb_native_method_bind(
    jvmti_env: *mut jvmtiEnv,
    jni_env: *mut JNIEnv,
    thread: jthread,
    method: jmethodID,
...
#[allow(unused_variables)]
unsafe extern "C" fn local_cb_resource_exhausted(
    jvmti_env: *mut jvmtiEnv,
    jni_env: *mut JNIEnv,
    flags: jint,
...
#[allow(unused_variables)]
unsafe extern "C" fn local_cb_single_step(
    jvmti_env: *mut jvmtiEnv,
    jni_env: *mut JNIEnv,
    thread: jthread,
    method: jmethodID,
...
#[allow(unused_variables)]
unsafe extern "C" fn local_cb_vm_init(
    jvmti_env: *mut jvmtiEnv,
    jni_env: *mut JNIEnv,
    thread: jthread,
) -> () {
    match CALLBACK_TABLE.vm_init {
        Some(function) => {
            function(jvmti_env, jni_env, thread);
        }
